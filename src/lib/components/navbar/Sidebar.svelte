...
<div in:fly out:fly="{{delay: 750}}" class="backdrop" on:click>
    <div class="nav-mobile-wrapper">
        ...
        <div class="socials">
            <a class="github border_rgb" href="https://github.com/kryptokrona/kryptokrona" target="_blank">
                <svg class="logo" height="18px" width="18px" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                    <g>
