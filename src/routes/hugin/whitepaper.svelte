...
<div class="wrapper">
    ...
    <a href="https://courses.cs.washington.edu/courses/csep590/05au/whitepaper_turnin/oss(10).pdf">3. Washington edu</a>
    ...
    <div>
        <br/>
        <a href="https://kryptokrona.se/Hugin_Whitepaper.pdf">Get as pdf</a>
    </div>
</div>
